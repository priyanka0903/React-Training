    ...
    return (
      <form onSubmit={this.handleSubmit}>
        <FormGroup>
          ...
          <input type="text" value={this.state.Name} placeholder="Enter your First Name" onChange={this.setName.bind(this)}/>
        </FormGroup>

        <FormGroup>
          <label htmlFor="email">Enter your email Id: </label>
          <input id="email" name="email" type="email" placeholder="Enter your Email Id" onChange={this.setEmail.bind(this)}/>
        </FormGroup>
